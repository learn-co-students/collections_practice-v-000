...
describe 'collections practice' do
  ...
  describe '#swap_elements_from_to' do
    it 'swap user specified elements' do
      expect(swap_elements_from_to(["Northern Hairy-Nosed Wombat", "Pygmy Three-Toed Sloth", "Red-Crested Tree Rat", "Angel Shark", "Boni Giant Sengi", "Plougshare Tortoise"], 2, 5)).to eq(["Northern Hairy-Nosed Wombat", "Pygmy Three-Toed Sloth", "Plougshare Tortoise", "Angel Shark", "Boni Giant Sengi", "Red-Crested Tree Rat"])
    end
  end
