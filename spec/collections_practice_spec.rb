...
describe 'collections practice' do
  ...
  describe '#swap_elements_from_to' do
    it 'swap elements with their specified indexes within an array' do
      expect(swap_elements_from_to(["Sydney", "Tokyo", "Anchorage"],0,2)).to eq(["Anchorage", "Tokyo", "Sydney"])
      expect(swap_elements_from_to(["Sydney", "Tokyo", "Anchorage"],2,1)).to eq(["Sydney", "Anchorage", "Tokyo"])
    end
  end
