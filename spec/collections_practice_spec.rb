...
describe 'collections practice' do
  ...
  #   it 'should return an array in with index element and destination_index in a swapped position' do
  #     expect(swap_elements_from_to(["dogs", "cat", "Horses"])).to eq(["dogs", "Horses", "cat"])
  #   end
  # end
