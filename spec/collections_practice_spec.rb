...
describe 'collections practice' do
  ...
  # Question 10
  describe '#swap_element_from_to' do
    it 'move the from_index to the to_index elements of an array' do
      expect(swap_element_from_to(["dog", "mouse", "cat"], 0, 2)).to eq(["mouse", "cat", "dog"])
    end
  end
end
