...
puts describe 'collections practice' do

  # Question 1
  puts describe '#sort_array_asc' do
  ...
  # Question 2
  puts describe '#sort_array_desc' do
  ...
  # Question 3
  puts describe '#sort_array_char_count' do
  ...
  # Question 4
  puts describe '#swap_elements' do
  ...
  # Question 5
  puts describe '#reverse_array' do
